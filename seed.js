...
module.exports = {
  ...
  syncAndSeed: function(){
      ...
      .spread(function(day1, day2, day3, restaurants, hotels, activities){
        return Promise.all([
            Meal.create({ dayId: day1.id, restaurantId: restaurants[0].id }),
            Stay.create({dayId: day1.id, hotelId: hotels[0].id}),
            Adventure.create({dayId: day1.id, activityId: activities[0].id}),
            Meal.create({ dayId: day2.id, restaurantId: restaurants[1].id }),
            Stay.create({dayId: day2.id, hotelId: hotels[1].id}),
            Adventure.create({dayId: day2.id, activityId: activities[1].id}),
            Meal.create({ dayId: day3.id, restaurantId: restaurants[2].id }),
            Stay.create({dayId: day3.id, hotelId: hotels[2].id}),
            Adventure.create({dayId: day3.id, activityId: activities[2].id}),
        ])
      })
      .then(function () {
